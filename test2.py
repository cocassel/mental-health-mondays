...
mental_health_comments = pandas.read_csv("mentalhealth_comments.csv")
...
print(model.predict(['I am kind of depressed!']))
print(model.predict(['Exams are taking a toll on me for sure!']))
print(model.predict(['Anxiety is really hard to live with']))
print(model.predict(['I like hamburgers']))
print(model.predict(['I am frustrated with life']))
print(model.predict(['I am frustrated with life', "blehhhh"]))
